...
module OCaml.BuckleScript.Package.Spec
  ( mkOCamlServer
  , MkOCamlSpecAPI  
...
mkOCamlServer :: forall ocamlPackage. (OCamlPackageTypeCount ocamlPackage, HasOCamlPackage ocamlPackage) => String -> Proxy ocamlPackage -> Q [Dec]
mkOCamlServer typeName Proxy = do
